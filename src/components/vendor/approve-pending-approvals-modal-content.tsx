...
const ApprovePendingApprovalsModalContent: FC<IPendingApprovalsModalContentProps> = ({ onClose, onAccept }) => {
  return (
    <ModalContent>
      <ModalHeader>Are you sure?</ModalHeader>
      <ModalCloseButton />
      <ModalBody mb={4}>
        <Text mb={4}>You are going to approve this/those vendor(s)</Text>
...
export default ApprovePendingApprovalsModalContent
