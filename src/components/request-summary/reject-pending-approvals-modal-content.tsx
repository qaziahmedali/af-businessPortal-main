...
const RejectPendingApprovalsTransactionModalContent: FC<IPendingApprovalsModalContentProps> = ({ onClose, onAccept }) => {
  return (
    <ModalContent>
      <ModalHeader>Are you sure?</ModalHeader>
      <ModalCloseButton />
      <ModalBody mb={4}>
        <Text mb={4}>You are going to reject the selected transactions(s)</Text>
...
export default RejectPendingApprovalsTransactionModalContent
